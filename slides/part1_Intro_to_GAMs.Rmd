...
We can create a penalty matrix that penalizes the squared second derivative of the curve across the range of the observed x-values:
...
* This will be useful when we look at model uncertainties later on
